...
- Visit the GitHub repository: https://github.com/napari/napari

## napari viewer

- native application you can launch from the terminal/command prompt or via the application programming interface (API)
